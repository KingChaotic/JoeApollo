...
import the.joeapollo.widgets.ColorPickerView.OnColorChangedListener;
...
public class ColorSchemeDialog extends AlertDialog implements
    ...
    /*
     * (non-Javadoc)
     * @see the.joeapollo.widgets.ColorPickerView.OnColorChangedListener#
     * onColorChanged(int)
     */
    @Override
