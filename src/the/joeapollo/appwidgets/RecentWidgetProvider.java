...
package the.joeapollo.appwidgets;

import the.joeapollo.Config;
import the.joeapollo.MusicPlaybackService;
import the.joeapollo.R;
import the.joeapollo.ui.activities.AudioPlayerActivity;
import the.joeapollo.ui.activities.HomeActivity;
import the.joeapollo.ui.activities.ProfileActivity;
import the.joeapollo.ui.activities.ShortcutActivity;
...
public class RecentWidgetProvider extends AppWidgetProvider {
    ...
    public static final String CLICK_ACTION = "the.joeapollo.recents.appwidget.action.CLICK";

    public static final String REFRESH_ACTION = "the.joeapollo.recents.appwidget.action.REFRESH";
