...
import the.joeapollo.IApolloService;
...
import the.joeapollo.appwidgets.AppWidgetLarge;
import the.joeapollo.appwidgets.AppWidgetLargeAlternate;
import the.joeapollo.appwidgets.AppWidgetSmall;
import the.joeapollo.appwidgets.RecentWidgetProvider;
import the.joeapollo.cache.ImageCache;
import the.joeapollo.cache.ImageFetcher;
import the.joeapollo.provider.FavoritesStore;
import the.joeapollo.provider.RecentStore;
import the.joeapollo.utils.ApolloUtils;
import the.joeapollo.utils.Lists;
import the.joeapollo.utils.MusicUtils;
import the.joeapollo.utils.PreferenceUtils;
import the.joeapollo.utils.SharedPreferencesCompat;
...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "the.joeapollo.playstatechanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "the.joeapollo.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "the.joeapollo.queuechanged";

    /**
     * Indicates the repeat mode chaned
     */
    public static final String REPEATMODE_CHANGED = "the.joeapollo.repeatmodechanged";

    /**
     * Indicates the shuffle mode chaned
     */
    public static final String SHUFFLEMODE_CHANGED = "the.joeapollo.shufflemodechanged";

    /**
     * Called to indicate a general service commmand. Used in
     * {@link MediaButtonIntentReceiver}
     */
    public static final String SERVICECMD = "the.joeapollo.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "the.joeapollo.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "the.joeapollo.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "the.joeapollo.stop";

    /**
     * Called to go to the previous track
     */
    public static final String PREVIOUS_ACTION = "the.joeapollo.previous";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "the.joeapollo.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "the.joeapollo.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "the.joeapollo.shuffle";

    /**
     * Called to kill the notification while Apollo is in the foreground
     */
    public static final String KILL_FOREGROUND = "the.joeapollo.killforeground";

    /**
     * Used to easily notify a list that it should refresh. i.e. A playlist
     * changes
     */
    public static final String REFRESH = "the.joeapollo.refresh";

    /**
     * Called to build the notification while Apollo is in the background
     */
    public static final String START_BACKGROUND = "the.joeapollo.startbackground";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "the.joeapollo.updatelockscreen";
